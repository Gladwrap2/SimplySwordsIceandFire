...
public class DragonsteelFireSwordItem extends SwordItem {

    public static int maxUseTime;

    public DragonsteelFireSwordItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, Settings settings) {
